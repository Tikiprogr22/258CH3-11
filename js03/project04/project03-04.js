...
function starImages(rating) {
    var imageText = "";
    //Create a loop to add the star image
    for (let i = 0; i < rating; i++) {
       imageText += `<img src='star.png' alt="star">`;
   } 
   //Return the value of the image text
   return imageText;
}
var htmlCode = "";
for (let i = 0; i < reviewers.length; i++) {
    ...
    reviewCode += `<caption>${reviewTitles[i]}
    </caption>
...
articleElement.insertAdjacentHTML("beforeend", htmlCode);